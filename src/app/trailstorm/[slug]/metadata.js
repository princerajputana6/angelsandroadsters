export const metadata = {
  ...
  keywords: [
    ...
    'Jaisalmer biking event',
    'adventure biking event Rajasthan',
    'amateur rider competition India',
    'motorcycle rally India',
    'desert off-road racing India',
    'biker festival',
    'motorcycle adventure',
    'riding clubs India',
    'desert rally experience',
    'ADV motorcycle event',
    'enduro event India',
  ...
  twitter: {
    ...
    title: 'TRAILSTORM 2026 Jaisalmer - Desert Motorcycle Festival',
    description: 'India\'s ultimate desert motorcycle adventure festival. Off-road racing, stunts, music, and brotherhood. Oct 30-31, 2026.',
  },
};
